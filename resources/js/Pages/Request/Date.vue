...
import { createInertiaApp, Head, router, Link } from '@inertiajs/vue3';
    ...
    let submit = () => {
        router.post('/request/defect/date/confirmation');
    }
</script>
<template>
    <MyLayout>
    ...
    <div class="gap-8 lg:flex">
      ...
      <form @submit.prevent="submit" class="w-full space-y-6 lg:space-y-8">
        ...
        <div class="flex flex-row space-x-6">
          ...
          <h3 class="text-xl font-semibold text-gray-900 dark:text-white">3. Select Date and Time:</h3>
          ...
          <div class="relative max-w-sm">
            <div class="absolute inset-y-0 start-0 flex items-center ps-3 pointer-events-none">
              ...
              <input type="date" id="datepicker-actions" datepicker datepicker-buttons datepicker-autoselect-today  class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Select date">
          </div>
